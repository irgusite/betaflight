...
TEST(pidControllerTest, testPidLoop) {
    ...
    EXPECT_FLOAT_EQ(-128.116, pidData[FD_ROLL].P);
    EXPECT_FLOAT_EQ(0, pidData[FD_PITCH].P);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].P);
    EXPECT_FLOAT_EQ(-7.8201923, pidData[FD_ROLL].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_PITCH].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].I);
    EXPECT_FLOAT_EQ(-198.375, pidData[FD_ROLL].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_PITCH].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].D);
    ...
    EXPECT_FLOAT_EQ(-128.116, pidData[FD_ROLL].P);
    EXPECT_FLOAT_EQ(185.7682, pidData[FD_PITCH].P);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].P);
    EXPECT_FLOAT_EQ(-15.640385, pidData[FD_ROLL].I);
    EXPECT_FLOAT_EQ(9.7752399, pidData[FD_PITCH].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_ROLL].D);
    EXPECT_FLOAT_EQ(231.43748, pidData[FD_PITCH].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].D);
    ...
    EXPECT_FLOAT_EQ(-128.116, pidData[FD_ROLL].P);
    EXPECT_FLOAT_EQ(185.7682, pidData[FD_PITCH].P);
    EXPECT_FLOAT_EQ(-224.20299, pidData[FD_YAW].P);
    EXPECT_FLOAT_EQ(-23.460577, pidData[FD_ROLL].I);
    EXPECT_FLOAT_EQ(19.55048, pidData[FD_PITCH].I);
    EXPECT_FLOAT_EQ(-8.7977161, pidData[FD_YAW].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_ROLL].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_PITCH].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].D);
    ...
    EXPECT_FLOAT_EQ(-23.460577, pidData[FD_ROLL].I);
    EXPECT_FLOAT_EQ(19.55048, pidData[FD_PITCH].I);
    EXPECT_FLOAT_EQ(-10.55726, pidData[FD_YAW].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_ROLL].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_PITCH].D);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].D);
...
TEST(pidControllerTest, testPidLevel) {
    ...
    EXPECT_FLOAT_EQ(2559.7576, pidData[FD_ROLL].P);
    EXPECT_FLOAT_EQ(-3711.6487, pidData[FD_PITCH].P);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].P);
...
TEST(pidControllerTest, testPidHorizon) {
    ...
    EXPECT_FLOAT_EQ(0.75277144, pidData[FD_ROLL].P);
    EXPECT_FLOAT_EQ(-1.0915185, pidData[FD_PITCH].P);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].P);
    EXPECT_FLOAT_EQ(150, pidData[FD_ROLL].I);
    EXPECT_FLOAT_EQ(-150, pidData[FD_PITCH].I);
    EXPECT_FLOAT_EQ(0, pidData[FD_YAW].I);
